...
e o que piorou?
R: A primeira forma havia apenas uma função com muitas responsabilidades diferentes
e muita repetição de código, o 

2). O que é e para que serve parâmetros do tipo função? Em que caso utilizamos?
R: parâmetros deixam as funções mais flexíveis, 
podendo serem usadas em mais situações, aumentando a reusabilidade
